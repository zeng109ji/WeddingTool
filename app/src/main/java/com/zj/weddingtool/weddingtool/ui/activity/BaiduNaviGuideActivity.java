...
public class BaiduNaviGuideActivity extends Activity {
    ...
    private final String TAG = BaiduNaviGuideActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaiduNaviMainActivity.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(BaiduNaviMainActivity.ROUTE_PLAN_NODE);
    ...
    protected void onDestroy() {
        ...
        BaiduNaviMainActivity.activityList.remove(this);
